...
<html>
	<head>
		...
		<title>Yarış Ekle | Profesyonel Derby 45</title>
		...
		<div class="container-fluid">
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="defaultNavbar1">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="#">Yarış Ekle</a></li>
			...
			<div class="panel panel-default">
				<div class="panel-heading">
					<h3 class="panel-title"><b>Yarış Ekle</b></h3>
				</div>
				<div class="panel-body">
					<div style="width: 327px;" class="center-block text-center">
						<form method="POST" action="engine/yarisekle.php" enctype="multipart/form-data" name="yar-ekle">
							<div id="place">
							    <p>Dosya adının Türkçe karekter ve boşluk içermemesine dikkat ediniz!</p>
							    <p>Örn: yarissonucu1.htm</p>
								<div class="input-group"><span id="addon1" class="input-group-addon" style="width: 160px;">YARIŞ ADI:</span>
									<input name="yaradi" type="text" class="form-control" placeholder="" required>
								</div>
								<div class="input-group"><span id="addon1" class="input-group-addon" style="width: 160px;">YARIŞ TARİHİ:</span>
									<input name="yartarih" type="text" class="form-control" placeholder="" required>
								</div>
			...
			<div style="text-align: center;">
				...
				<?php
					if($sor=="true"){
				?>
				<b>Yarış başarılı bir şekilde Eklendi!</b>
				<?php
					}
				?>
			</div>
