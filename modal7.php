	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<h4>ANTREMAN ADI: <?php echo tr_strtoupper($row['ad']); ?></h4>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger pull-left" onclick="location.href='engine/yarissilme.php?id=<?php echo $row['id']; ?>'">Evet</button>
