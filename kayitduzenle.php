...
<html>
	<head>
		...
		<title>Kayıt Düzenle | Profesyonel Derby 45</title>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="defaultNavbar1">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="#">Kayıt Düzenle</a></li>
			...
			<div>
				<div class="panel panel-default filterable">
					<div class="panel-heading">
						<h3 class="panel-title"><b>Kayıt Düzenle</b></h3>
						<div class="pull-right">
    				     <button class="btn btn-default btn-xs" onClick="parent.location='./kayitduzenle.php?sort=sort'">Alfabetik Sıralama</button>
						...
						?>
						<div class="text-center">
						<b>Kayıt başarılı bir şekilde düzenlendi!</b>
						</div>
						<?php
							}
						?>
					...
					<table class="table text-center">
						<thead>
							...
							<th><input type="text" class="form-control text-center" placeholder="AD" disabled></th>
							<th><input type="text" class="form-control text-center" placeholder="SOYAD" disabled></th>
							<th><input type="text" class="form-control text-center" placeholder="KÜNYE NO" disabled></th>
							<th><input type="text" class="form-control text-center" placeholder="ŞEHİR" disabled></th>
							<th><input type="text" class="form-control text-center" placeholder="ÜLKE" disabled></th>
							<th><input type="text" class="form-control text-center" placeholder="DURUM" disabled></th>
