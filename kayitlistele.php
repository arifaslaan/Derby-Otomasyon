...
<html>
	<head>
		...
		<title>Kayıt Listele | Profesyonel Derby 45</title>
				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="defaultNavbar1">
						<ul class="nav navbar-nav">
							<li class="active"><a href="#">Kayıt Listele</a></li>
			...
			<div>
				<div class="panel panel-default filterable">
					<div class="panel-heading">
						<h3 class="panel-title"><b>Kayıt Listele</b></h3>
						<div class="pull-right">
						    <button class="btn btn-default btn-xs" onClick="parent.location='./kayitlistele.php?sort=sort'">Alfabetik Sıralama</button>
